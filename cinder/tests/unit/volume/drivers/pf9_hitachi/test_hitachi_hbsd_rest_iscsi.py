...
class HBSDRESTISCSIDriverTest(test.TestCase):
    ...
    def _setup_config(self):
        ...
        self.override_config('volume_backend_name', "RESTISCSI",
        ...
        self.override_config('hitachi_replication_journal_use_cache', True,
                             group=conf.SHARED_CONF_GROUP)
        self.override_config('hitachi_replication_journal_transfer_speed',
                             256, group=conf.SHARED_CONF_GROUP)
        self.override_config('hitachi_replication_journal_creation_speed',
                             'L', group=conf.SHARED_CONF_GROUP)
        self.override_config(
    ...
    def test_do_setup_create_hg_format(
        ...
        self._setup_config()
        self.override_config('hitachi_group_name_format',
                             'HBSD-{ip}@{host}-_:.',
                             group=conf.SHARED_CONF_GROUP)
        request.side_effect = [FakeResponse(200, POST_SESSIONS_RESULT),
                               FakeResponse(200, GET_PORTS_RESULT),
